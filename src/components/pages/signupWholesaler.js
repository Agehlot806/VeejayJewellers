                    ...
                    <Col lg={6} className='mainForm-bg'>
                        <div className="mainForm-text">
                            ...
                            <div className="btn-section">
                                ...
                                <Link to="/signUp-wholesaler" className="btn-theme-3">SignUp Wholesaler</Link>
                            </div>
                        </div>
                    </Col>
                    <Col lg={6}>
                                        ...
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                {error && f_name.length <= 0 ?
                                                    <span className='validationErr'>First name is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                <Form.Label>Last Name</Form.Label>
                                                <Form.Control type="text" placeholder="Enter last name" value={l_name}
                                                    onChange={(e) => setl_name(e.target.value)}
                                                />
                                                {error && l_name.length <= 0 ?
                                                    <span className='validationErr'>Last name is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                <Form.Control type="number" placeholder="Enter mobile number" value={phone}
                                                    onChange={(e) => setphone(e.target.value)}
                                                />
                                                {error && phone.length <= 0 ?
                                                    <span className='validationErr'>Phone number is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                ...
                                                {error && email.length <= 0 ?
                                                    <span className='validationErr'>Email is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                        <Row className="mb-3">
                                            <Form.Group as={Col} >
                                                ...
                                                <Form.Control type="password" placeholder="Enter set password" value={password}
                                                    onChange={(e) => setpassword(e.target.value)}
                                                />
                                                {error && password.length <= 0 ?
                                                    <span className='validationErr'>Set password is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col} >
                                                ...
                                                />
                                                {error && password.length <= 0 ?
                                                    <span className='validationErr'>Confirm password is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                    ...
                                    <div className="stepform">
                                        ...
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                <Form.Control type="text" placeholder="Enter company name" value={company_name}
                                                    onChange={(e) => setcompany_name(e.target.value)}
                                                />
                                                {error && company_name.length <= 0 ?
                                                    <span className='validationErr'>Company name is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                <Form.Label>Date Formulation</Form.Label>
                                                <Form.Control type="date" placeholder="Enter date formulation" value={foundation_date}
                                                    onChange={(e) => setfoundation_date(e.target.value)}
                                                />
                                                {error && foundation_date.length <= 0 ?
                                                    <span className='validationErr'>Date Formulation is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                        ...
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                <Form.Select aria-label="Default select example" onChange={Subscription}
                                                    value={state}>
                                                ...
                                                {error && state.length <= 0 ?
                                                    <span className='validationErr'>State is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                <Form.Label>City</Form.Label>
                                                <Form.Select aria-label="Default select example" onChange={Subscriptioncity} value={city}>
                                                    <option>Choose...</option>
                                                ...
                                                {error && city.length <= 0 ?
                                                    <span className='validationErr'>City is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                <Form.Control type="number" placeholder="Enter pincode" value={pincode}
                                                    onChange={(e) => setpincode(e.target.value)}
                                                />
                                                {error && pincode.length <= 0 ?
                                                    <span className='validationErr'>Pincode is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                <Form.Label>GST Number</Form.Label>
                                                <Form.Control type="number" placeholder="Enter gst number" value={gst_number}
                                                    onChange={(e) => setgst_number(e.target.value)}
                                                />
                                                {error && gst_number.length <= 0 ?
                                                    <span className='validationErr'>GST number is required.</span>
                                                    : ""}
                                            </Form.Group>
                                        </Row>
                                        <Row className="mb-3">
                                            <Form.Group as={Col}>
                                                ...
                                                <Form.Control type="file" placeholder="Enter company name"
                                                    onChange={imagefirst}
                                                />
                                                {error && upload1.length <= 0 ?
                                                    <span className='validationErr'>Upload File is required.</span>
                                                    : ""}
                                            </Form.Group>
                                            <Form.Group as={Col}>
                                                <Form.Label>Upload 2</Form.Label>
                                                <Form.Control type="file" placeholder="Enter date formulation"
                                        ...
                                        <div className='mainForm-btn'>
                                            <Button style={{ width: '180px', margin: '4px' }} onClick={prevStep}>
                                                Previous
                                            </Button>
                                            <Button style={{ width: '180px', margin: '4px' }} type="submit" onClick={handlewholesales}>
                                                Submit
                                            </Button>
                                        </div>
                                    </div>
