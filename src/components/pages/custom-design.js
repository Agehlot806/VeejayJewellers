                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col lg={9}>
                                ...
                                <p className='text-center'>Visit our showroom for all your jewelry needs</p>
                        </Col>
                    </Row>
                    <Row className="justify-content-center mt-3">
                        <Col lg={10}>
                            <div className='contact-form'>
                                ...
                                <p>Please complete the required fields below to make an appointment *</p>
                                <Form>
                                    <Row className="mb-3">
                                        <Form.Group as={Col}>
                                    ...
                                    <Row className="mb-3">
                                        ...
                                        <Form.Group as={Col}>
                                            ...
                                            <Form.Select aria-label="Default select example">
                                                <option selected="true" disabled="disabled">Select Price</option>
                                    ...
                                    <Row className="mb-3">
                                        <Form.Group as={Col}>
                                            <Form.Label>Upload images to help guide your request (JPG, GIF, PNG)</Form.Label>
                                            <Form.Control
                                                type="file"
                                            />
                                        </Form.Group>
