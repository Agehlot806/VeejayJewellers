                ...
                <div className='section-padding'>
                    <div className='AllPage-area'>
                        <Container>
                            <Row>
                                <Col lg={7}>
                                    <h2>NEW COLLECTION “ARHA”</h2>
                                    <Link to=''><i className="fa fa-angle-double-right" /> Shop now</Link>
                                </Col>
                            </Row>
                        </Container>
                    </div>
                    ...
                    <Row className="justify-content-center">
                        <Col lg={7}>
                            <div className='bestseller'>
                                <h4 className='main-heading'>V’Arha Category’s</h4>
                            </div>
                        </Col>
                    </Row>
                        ...
                        <Row className='mt-4'>
                            <Col sm={3}>
                                <Nav variant="pills" className="flex-column brand-cate-list">
                                    <Nav.Item>
                                        <Nav.Link eventKey="first">Half Round</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                    ...
                                    <Nav.Item>
                                        <Nav.Link eventKey="Ladies bracelets">Ladies bracelets</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Flexible bracelets">Flexible bracelets</Nav.Link>
                                    </Nav.Item>
                                    <Nav.Item>
                                        <Nav.Link eventKey="Calcutti bangles">Calcutti bangles</Nav.Link>
                                    </Nav.Item>
                                </Nav>
                            </Col>
                            <Col sm={9}>
